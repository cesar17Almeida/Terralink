...
object TerraIcons {
    ...
    val Terminal: ImageVector by lazy {
        materialIcon(
            ...
            "M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 " +
                "14H4V8h16v10zM6 10l1.41-1.41L10.83 12l-3.42 3.41L6 14l2-2-2-2zm6 5h6v-2h-6v2z",
        )
    }
    val Antenna: ImageVector by lazy {
        materialIcon(
            ...
            "M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm1 " +
                "9.29c.88-.39 1.5-1.26 1.5-2.29 0-1.38-1.12-2.5-2.5-2.5S9.5 10.62 9.5 12c0 1.02.62 " +
                "1.9 1.5 2.29v3.3L7.59 21 9 22.41l3-3 3 3L16.41 21 13 17.59v-3.3zM12 3c4.97 0 9 4.03 " +
    ...
    val Sensors: ImageVector by lazy {
        materialIcon(
            "Sensors",
            "M7.76 16.24C6.67 15.16 6 13.66 6 12s.67-3.16 1.76-4.24l1.42 1.42C8.45 9.9 8 10.9 8 " +
                "12c0 1.1.45 2.1 1.17 2.83l-1.41 1.41zm8.48 0C17.33 15.16 18 13.66 18 12s-.67-3.16" +
                "-1.76-4.24l-1.42 1.42C15.55 9.9 16 10.9 16 12c0 1.1-.45 2.1-1.17 2.83l1.41 1.41zM12 " +
                "10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM4.93 19.07C3.12 17.26 2 14.76 2 " +
                "12s1.12-5.26 2.93-7.07l1.42 1.42C4.9 7.79 4 9.79 4 12s.9 4.21 2.35 5.66l-1.42 " +
                "1.41zm14.14 0l-1.42-1.42C19.1 16.21 20 14.21 20 12s-.9-4.21-2.35-5.66l1.42-1.42C20.88 " +
                "6.74 22 9.24 22 12s-1.12 5.26-2.93 7.07z",
        )
    }
    ...
    val Bolt: ImageVector by lazy {
        materialIcon("Bolt", "M7 2v11h3v9l7-12h-4l4-8z")
    }
    val Timeline: ImageVector by lazy {
        materialIcon(
            "Timeline",
            "M23 8c0 1.1-.9 2-2 2-.18 0-.35-.02-.51-.07l-3.56 3.55c.05.16.07.34.07.52 0 " +
                "1.1-.9 2-2 2s-2-.9-2-2c0-.18.02-.36.07-.52l-2.55-2.55c-.16.05-.34.07-.52.07s-.36-.02" +
                "-.52-.07l-4.55 4.56c.05.16.07.33.07.51 0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2c.18 0 .35.02" +
                ".51.07l4.56-4.55C8.02 9.36 8 9.18 8 9c0-1.1.9-2 2-2s2 .9 2 2c0 .18-.02.36-.07.52l2.55 " +
    ...
    val Target: ImageVector by lazy {
        materialIcon(
            "Target",
            "M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm0 18c-4.41 " +
                "0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-14c-3.31 0-6 2.69-6 6s2.69 6 6 6 " +
                "6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm0-6c-1.1 " +
    ...
    val ToggleOn: ImageVector by lazy {
        materialIcon(
            "ToggleOn",
            "M17 7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h10c2.76 0 5-2.24 5-5s-2.24-5-5-5zm0 " +
                "8c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z",
        )
    }
    ...
    val Info: ImageVector by lazy {
        materialIcon(
            ...
            "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 " +
                "18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v2h-2zm0 4h2v6h-2z",
        )
    }
    val Straighten: ImageVector by lazy {
        materialIcon(
            "Straighten",
            "M21 6H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm0 " +
                "10H3V8h2v4h2V8h2v4h2V8h2v4h2V8h2v4h2V8h2v8z",
        )
    }
}
